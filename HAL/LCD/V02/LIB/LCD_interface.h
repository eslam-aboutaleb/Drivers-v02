...
typedef unsigned char								LCD_Port_t;
...
/* ***************************************************************************** */
#define LCD_MAX_PIN_NUM									8
#define LCD_E_PIN_INDEX									0
#define LCD_RW_PIN_INDEX								1
#define LCD_RS_PIN_INDEX								2

typedef struct{
	LCD_Port_t	LCD_DATA_PORT[LCD_MAX_PIN_NUM];
	LCD_Pin_t	LCD_DATA_PIN[LCD_MAX_PIN_NUM];
	LCD_Port_t	LCD_CNTRL_PORT[LCD_MAX_PIN_NUM];
	LCD_Pin_t	LCD_CNTRL_PIN[LCD_MAX_PIN_NUM];
}LCD_Typedef;
 ...
 * Return  		: 	Error_Status		, Type	:	User defined type
 * Parameters	:	LCDx				, Type	:	LCD_configType
 * 					Copy_u8Line_Position, Type	:	uint8
 ...
 * Return  		: 	Error_Status		, Type	:	User defined type
 * Parameters	:	LCDx				, Type	:	LCD_configType
 * 					Copy_pu8CharacteArr	, Type	:	Pointer to uint8
